...
FLAGS=(
  ...
  -lavdevice -lavfilter -lavformat -lavcodec -lswresample -lswscale -lavutil -lpostproc -lm -lx264 -lvpx -lmp3lame -lfdk-aac -lz -lopus -lwebp
